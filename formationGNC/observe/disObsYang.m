function observer = disObsYang(xiInputs,observer,commands,ASV,Ts)
%DISOBSYANG  Nonlinear disturbance observer (Yang's method) for ASV model.
%
%   observer = disObsYang(xiInputs, observer, commands, ASV, Ts)
%   updates the disturbance estimate for a single ASV based on nonlinear
...
%     ASV       - Struct, must contain .dynamics (with full parameter set)
